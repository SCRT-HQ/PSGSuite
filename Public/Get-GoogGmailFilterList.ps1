function Get-GoogGmailFilterList {
    [cmdletbinding()]
    Param
    (
...
try
    {
    $response = Invoke-RestMethod -Method Get -Uri $URI -Headers $header | Select-Object -ExpandProperty filter
    if (!$Raw)
        {
        $response = $response | Select-Object id,@{N="from";E={$_.criteria.from}},@{N="to";E={$_.criteria.to}},@{N="subject";E={$_.criteria.subject}},@{N="query";E={$_.criteria.query}},@{N="negatedQuery";E={$_.criteria.negatedQuery}},@{N="hasAttachment";E={$_.criteria.hasAttachment}},@{N="excludeChats";E={$_.criteria.excludeChats}},@{N="size";E={$_.criteria.size}},@{N="sizeComparison";E={$_.criteria.sizeComparison}},@{N="addLabelIds";E={$_.action.addLabelIds}},@{N="removeLabelIds";E={$_.action.removeLabelIds}},@{N="forward";E={$_.action.forward}}
        }
    }
catch
    {
