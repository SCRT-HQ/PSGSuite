...
if ($CanAddChildren -or $CanComment -or $CanCopy -or $CanDeleteTeamDrive -or $CanDownload -or $CanEdit -or $CanListChildren -or $CanManageMembers -or $CanReadRevisions -or $CanRemoveChildren -or $CanRename -or $CanRenameTeamDrive -or $CanShare){$body.Add("capabilities",@{})}
