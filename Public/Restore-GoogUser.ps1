...
.DESCRIPTION
   Restores a deleted Google user
.EXAMPLE
   Restore-GoogUser -User john.smith@domain.com -OrgUnitPath "/Users/Rehires" -WhatIf
.EXAMPLE
   Restore-GoogUser -User john.smith@domain.com -OrgUnitPath "/Users/Rehires" -Confirm:$false
#>
...
if (!$AccessToken)
    ...
    $AccessToken = Get-GoogToken -P12KeyPath $P12KeyPath -Scopes "https://www.googleapis.com/auth/admin.directory.user" -AppEmail $AppEmail -AdminEmail $AdminEmail -Verbose:$false
    if ($AccessToken)
        {
