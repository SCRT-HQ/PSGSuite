function Add-GSSheetCandlestickChartSpec {
    ...
    .PARAMETER Data
    Accepts the following type: [Google.Apis.Sheets.v4.Data.CandlestickData[]].

    To create this type, use the function Add-GSSheetCandlestickData or instantiate the type directly via New-Object 'Google.Apis.Sheets.v4.Data.CandlestickData'.

    .PARAMETER Domain
    Accepts the following type: [Google.Apis.Sheets.v4.Data.CandlestickDomain].

    To create this type, use the function Add-GSSheetCandlestickDomain or instantiate the type directly via New-Object 'Google.Apis.Sheets.v4.Data.CandlestickDomain'.
            ...
            switch ($PSCmdlet.ParameterSetName) {
                Fields {
                    ...
                    foreach ($prop in $PSBoundParameters.Keys | Where-Object {$obj.PSObject.Properties.Name -contains $_}) {
                        switch ($prop) {
                            Data {
                                $list = New-Object 'System.Collections.Generic.List[Google.Apis.Sheets.v4.Data.CandlestickData]'
