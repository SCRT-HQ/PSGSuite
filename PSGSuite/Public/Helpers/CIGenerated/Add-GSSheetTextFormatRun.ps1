function Add-GSSheetTextFormatRun {
    <#
    .SYNOPSIS
    Creates a Google.Apis.Sheets.v4.Data.TextFormatRun object.
    ...
    .EXAMPLE
    Add-GSSheetTextFormatRun -Format $format -StartIndex $startIndex
    #>
    [OutputType('Google.Apis.Sheets.v4.Data.TextFormatRun')]
    [CmdletBinding()]
    Param(
        [parameter()]
    ...
    Process {
        try {
            switch ($PSCmdlet.ParameterSetName) {
                Fields {
                    $obj = New-Object 'Google.Apis.Sheets.v4.Data.TextFormatRun'
