...
### Icon (Default)
```
Add-GSChatKeyValue [-TopLabel <String>] [-Content <String>] [-BottomLabel <String>] [-Icon <String>]
 [-ContentMultiline] [-OnClick <Object>] [-Button <Object>] [-MessageSegment <Object[]>] [<CommonParameters>]
```

### IconUrl
```
Add-GSChatKeyValue [-TopLabel <String>] [-Content <String>] [-BottomLabel <String>] [-IconUrl <String>]
 [-ContentMultiline] [-OnClick <Object>] [-Button <Object>] [-MessageSegment <Object[]>] [<CommonParameters>]
```
