...
```
Add-GSChatCard [[-HeaderTitle] <String>] [-HeaderSubtitle <String>] [-HeaderImageStyle <String>]
 [-HeaderImageUrl <String>] [-CardActions <Object[]>] [-MessageSegment <Object[]>] [<CommonParameters>]
```
